  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-4 mt-8">
        {' '}
        {/* slightly wider card */}
        <div className="bg-white dark:bg-boxdark rounded-2xl shadow-2xl p-8 flex flex-col items-center transition-transform hover:scale-105">
          {/* QR Code */}
          <div className="bg-gradient-to-r rounded-xl mb-4">
            {qrCodeImage ? (
              <img
                src={qrCodeImage}
                alt="Your QR Code"
                className="h-60 w-60 rounded-lg bg-white  object-contain" // enlarged image
              />
            ) : (
              <div className="h-56 w-56 rounded-lg bg-gray-200 flex items-center justify-center text-sm text-gray-500 text-center px-4">
          ...
          {/* QR Code String */}
          <h1 className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-4 text-center">
            {qrCodeString}
          </h1>

          {/* Student Info */}
          <h3 className="font-bold text-base sm:text-lg md:text-xl text-[#071c4f] text-center mb-1">
            {fullName}
          </h3>
